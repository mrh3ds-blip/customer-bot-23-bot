...
const TEMPLATE_CODE: string = "TEST_BOT";
const TEMPLATE_TITLE = "🧪 ربات تست رایگان ۵ دقیقه‌ای";
const FEATURES = [
...
function defaultSettings(): Settings {
  return {
    businessName: "ماهان",
    welcomeMessage: "خوش آمد",
    supportContact: "ایران",
